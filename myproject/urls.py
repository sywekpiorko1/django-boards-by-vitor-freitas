...
urlpatterns = [
    ...
    path('', views.BoardListView.as_view(), name='home'),   # GCBV
    ...
    # path('boards/<int:pk>/', views.board_topics, name='board_topics'),    # FBV
    path('boards/<int:pk>/', views.TopicListView.as_view(), name='board_topics'),   #GCBV
    path('boards/<int:pk>/new/', views.new_topic, name='new_topic'),
    # path('boards/<int:pk>/topics/<int:topic_pk>/', views.topic_posts, name='topic_posts'),    # FBV
    path('boards/<int:pk>/topics/<int:topic_pk>/', views.PostListView.as_view(), name='topic_posts'),     # GCBV
